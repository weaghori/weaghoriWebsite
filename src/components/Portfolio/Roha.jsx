...
import { rohaData } from './PortfolioContents/Index'
    ...
    return (
        <>
            ...
            >
                {rohaData.map((roha) => (
                    <>
                        ...
                        <div className="w-full mb-20 pt-[110px]">
                            <h1 className="text-5xl mb-[20px] mt-12">{roha.title}</h1>
                            <p className="text-xl md:text-xl font-normal mb-6">
                                {roha.description}
                            </p>
                            <div className="py-8">
                                <h2 className="text-xl">Client</h2>
                                <h3 className="text-[16px]">{roha.title}</h3>
                                <br />
                                <h2 className="text-xl">Services</h2>
                                <h3 className="text-[16px]">{roha.services}</h3>
                            </div>
                        </div>
                        {/* content section start */}
                ...
                {/* Navigation start */}
                <Navigation clientName={rohaData[0].routingLabel} />
                {/* Navigation start */}
            </div>
