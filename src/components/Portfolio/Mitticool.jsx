...
import { mitticoolData } from './PortfolioContents/Index'
    ...
    return (
        <>
            ...
            >
                {mitticoolData.map((mitticool) => (
                    <>
                        ...
                        <div className="w-full mb-20 pt-[110px]">
                            <h1 className="text-5xl mb-[20px] mt-12">{mitticool.title}</h1>
                ...
                {/* Navigation start */}
                <Navigation clientName={mitticoolData[0].routingLabel} />
                {/* Navigation start */}
            </div>
