  ...
  return (
    <>
      ...
      <div
        ...
        className="w-[70px] h-[70px] md:w-[100px] md:h-[100px] moveViewMoreBtn"
      ></div>
      <motion.div
        drag
        dragConstraints={{ left: 0, top: 0, right: 0, bottom: 0 }}
        whileHover={{ scale: 1.1 }}
        className="w-[70px] h-[70px] md:w-[100px] md:h-[100px] flex justify-center items-center rounded-full absolute z-10 viewMoreBtn"
        ref={btnRef}
      >
        <svg
          width="30"
